        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-xs p-6 text-center">
            ...
            <p className="text-gray-600 mt-2">
              Blockchain developer with 8+ years of experience in financial technologies.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xs p-6 text-center">
            ...
            <p className="text-gray-600 mt-2">
              Smart contract expert and former fintech security consultant.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-xs p-6 text-center">
            ...
            <p className="text-gray-600 mt-2">
              Full-stack developer specialized in Web3 and decentralized applications.
            </p>
          </div>
        </div>
      </div>
